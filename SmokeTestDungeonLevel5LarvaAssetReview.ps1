...
$screenshotPath = Join-Path $workspace "Saved\Automation\WindowedLarvaAssetReviewViewport.png"
...
try {
    $arguments = @(
        ...
        "-WinX=160",
        "-WinY=160",
        "-ExecCmds=BroodDungeonLevel5LarvaAssetReviewSmokeTest"
    )
    ...
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_STARTED"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_TURNAROUND_READY"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_DIRECTION_MARKER_HIDDEN_READY"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_STAGE_READY"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_CLOSED_STAGE_READY"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_FRAMING_READY"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_SCREENSHOT_REQUESTED"
    Wait-LogPattern "BROOD_DUNGEON_LEVEL5_LARVA_ASSET_REVIEW_PASSED"
    ...
    if (-not (Test-Path $screenshotPath) -or (Get-Item $screenshotPath).Length -le 0) {
        throw "The larva asset review screenshot was not written: $screenshotPath"
    }

    Write-Host "Dungeon Level 5 larva asset review passed: screenshot saved to $screenshotPath"
}
finally {
