...
if "%UE_ROOT%"=="" if defined UE_5_3_ROOT if exist "%UE_5_3_ROOT%\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=%UE_5_3_ROOT%"
...
if "%UE_ROOT%"=="" if exist "C:\Program Files\Epic Games\UE_5.7EA\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=C:\Program Files\Epic Games\UE_5.7EA"
if "%UE_ROOT%"=="" if exist "D:\Epic Games\UE_5.7.4\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=D:\Epic Games\UE_5.7.4"
if "%UE_ROOT%"=="" if exist "D:\Epic Games\UE_5.7\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=D:\Epic Games\UE_5.7"
if "%UE_ROOT%"=="" if exist "D:\Program Files\Epic Games\UE_5.7.4\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=D:\Program Files\Epic Games\UE_5.7.4"
if "%UE_ROOT%"=="" if exist "D:\Program Files\Epic Games\UE_5.7\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=D:\Program Files\Epic Games\UE_5.7"
if "%UE_ROOT%"=="" if exist "E:\Epic Games\UE_5.7.4\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=E:\Epic Games\UE_5.7.4"
if "%UE_ROOT%"=="" if exist "E:\Epic Games\UE_5.7\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=E:\Epic Games\UE_5.7"
if "%UE_ROOT%"=="" if exist "E:\Program Files\Epic Games\UE_5.7.4\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=E:\Program Files\Epic Games\UE_5.7.4"
if "%UE_ROOT%"=="" if exist "E:\Program Files\Epic Games\UE_5.7\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=E:\Program Files\Epic Games\UE_5.7"
if "%UE_ROOT%"=="" if exist "C:\Program Files\Epic Games\UE_5.3\Engine\Binaries\Win64\UnrealEditor.exe" set "UE_ROOT=C:\Program Files\Epic Games\UE_5.3"
...
if "%UE_ROOT%"=="" (
    ...
    echo   UE_5_7_ROOT
    echo   UE_5_3_ROOT
    echo   common Epic Games UE_5.7 and UE_5.3 install paths
